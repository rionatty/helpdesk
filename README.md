...
python3 ./easy-install.py deploy \
    ...
    --image=ghcr.io/rionatty/helpdesk \
    --version=stable \
    --app=helpdesk \
...
**Step 1**: Setup folder and download the required files
    ...
    wget -O docker-compose.yml https://raw.githubusercontent.com/rionatty/helpdesk/main/docker/docker-compose.yml

    # Download the setup script
    wget -O init.sh https://raw.githubusercontent.com/rionatty/helpdesk/main/docker/init.sh
...
1. Get the Helpdesk app. Run `bench get-app https://github.com/rionatty/helpdesk`
